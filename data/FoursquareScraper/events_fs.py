...
#* Code is the same as FoursquareScrape_Postgres.py, but here I am trying to only retrieve events without dates
...
for data in responses:
    ...
    for result in data.get('results', []):
                ...
                events_to_db(name, address, latitude, longitude)
